...
export const projects: Project[] = [
  {
    title: "EchoMail",
    featured: true,
    description: "A powerful email marketing tool with CSV upload, auto-personalization, and Gmail API integration for seamless bulk email campaigns.",
    technologies: ["React", "Gmail API", "CSV Processing", "Bulk Operations"],
  ...
  },
  {
    ...
    description: "Gemini AI–based ATS resume scanner with intelligent matching and comprehensive analysis capabilities.",
  ...
  },
  {
    ...
    description: "Professional-grade AI research platform delivering multi-source synthesized reports with real-time financial data integration.",
    technologies: ["Next.js", "OpenRouter", "LangSearch", "Alpha Vantage", "Bun"],
    github: "https://github.com/Aditya190803/AI-Research-Agent",
    demo: "https://ai-research-agent.adityamer.live",
    category: "GenAI",
    features: [
      "Multi-stage research workflow (Exploration, Clarification, Strategy, Synthesis)",
      "Real-time financial data integration via Alpha Vantage",
      "Autonomous web crawling and information retrieval using LangSearch",
      "State-aware interactive interface with real-time feedback",
      "Source transparency with direct citations and history management",
    ],
    lessonsLearned: "Implemented a sophisticated multi-stage research pipeline with intent alignment and parallel retrieval, mastering Next.js 15 App Router and complex state-aware AI workflows.",
  },
  {
    title: "Chat With PDF",
